...
class AI4CRobotArmDevice:
    ...
    @action(description="步骤14/20：将孔板放置到移液站")
    ...
    @action(description="步骤16/21：从移液站取回孔板")
    ...
    @action(description="步骤17：将孔板放置到磁搅")
    ...
    @action(description="步骤19：从磁搅取回孔板")
    ...
    @action(description="步骤22：将孔板放置到 HPLC 站")
    ...
    @action(description="步骤24：从 HPLC 站取回孔板")
