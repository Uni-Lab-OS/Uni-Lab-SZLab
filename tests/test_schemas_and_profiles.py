...
def test_package_catalog_contains_typed_actions(action_catalog: dict) -> None:
    assert "szlab_mixer_stirrer.run_stirring" in action_catalog
    assert "szlab_s08_cap_station.process_cap_with_sample_parts" in action_catalog
