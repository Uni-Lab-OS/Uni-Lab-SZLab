...
@workflow(
    ...
    description='从 S3-L1B1 取烧杯，依次经 S0721、S061、BEAKER1、S041 转运，最后放到 S051；每段均使用标准物料转运并提交 OS 物料位置。',
)
def s_z_lab_烧杯五工位搬运() -> SZLab烧杯五工位搬运Result:
    ...
    beaker_at_s06 = s_z_lab_标准物料转运(resource=beaker_at_s0721.resource, source_site='S0721', source_warehouse=resource_ref("s07_process_warehouse"), target_device='szlab_mixer_pump', target_site='S061', target_warehouse=resource_ref("s06_process_warehouse"))
    # unilab:node_uuid=4499a4bc-01d8-5de5-ba8b-a289558aecc0
    beaker_at_s09 = s_z_lab_标准物料转运(resource=beaker_at_s06.resource, source_site='S061', source_warehouse=resource_ref("s06_process_warehouse"), target_device='szlab_mixer_pipetting_station', target_site='BEAKER1', target_warehouse=resource_ref("szlab_mixer_pipetting_station"))
    # unilab:node_uuid=e25a0f92-dccc-577c-94fd-129861a44a8a
    beaker_at_s041 = s_z_lab_标准物料转运(resource=beaker_at_s09.resource, source_site='BEAKER1', source_warehouse=resource_ref("szlab_mixer_pipetting_station"), target_device='szlab_mixer_stirrer', target_site='S041', target_warehouse=resource_ref("s04_process_warehouse"))
    # unilab:node_uuid=a2d777e4-4635-553f-85c5-4f67135868af
    beaker_at_s05 = s_z_lab_标准物料转运(resource=beaker_at_s041.resource, source_site='S041', source_warehouse=resource_ref("s04_process_warehouse"), target_device='szlab_mixer_photoshotting', target_site='S051', target_warehouse=resource_ref("s05_process_warehouse"))
