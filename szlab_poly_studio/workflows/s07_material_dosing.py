    ...
    *,
    ...
    with parallel():
        ...
        with group(name='烧杯搬运'):
            ...
            picked_beaker = szlab_mixer_robot_device.pick(resource=source_beaker, site='L1B1', transfer_id=beaker_transfer_id, warehouse=resource_ref('s3_unused_beaker'))
            # unilab:node_uuid=6c673893-36e1-5674-aeeb-8bac8c9197c4
            placed_beaker = szlab_mixer_robot_device.place(resource=picked_beaker.resource, site='S0722', transfer_id=beaker_transfer_id, warehouse=resource_ref('s07_process_warehouse'))
        ...
        with group(name='粉桶搬运'):
            ...
            picked_powder = szlab_mixer_robot_device.pick(resource=source_powder, site='L1C1', transfer_id=powder_transfer_id, warehouse=resource_ref('powder_container_warehouse'))
            ...
            placed_powder = szlab_mixer_robot_device.place(resource=prepared_powder.powder_cartridge, site='P01', transfer_id=powder_transfer_id, warehouse=resource_ref('s07_process_warehouse'))
