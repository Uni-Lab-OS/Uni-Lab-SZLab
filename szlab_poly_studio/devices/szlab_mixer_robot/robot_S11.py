...
from szlab_poly_studio.devices.szlab_mixer_robot.robot_tasks import build_variables, product_slot_sensor
...
class SzlabRobotS11Mixin:
    def _run_s11_place(self, product_type: int, position: str = "1-1") -> dict[str, Any]:
        ...
        return self._submit_robot_task(
            ...
            variables=build_variables(
                "place_to_s11", S11取放料产品=product_type, S11取放料编号=self._slot_number(position)
            ),
    ...
    def _run_s11_pick(self, product_type: int, position: str = "1-1") -> dict[str, Any]:
        ...
        return self._submit_robot_task(
            ...
            task_number=24,
            variables=build_variables(
                "pick_from_s11", S11取放料产品=product_type, S11取放料编号=self._slot_number(position)
            ),
            reset_variables={"S11取放料产品": 0, "S11取放料编号": 0, "任务号": 0},
